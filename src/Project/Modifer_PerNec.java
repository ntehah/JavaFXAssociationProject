...
public class Modifer_PerNec implements Initializable{
	...
	public void ModifierButtonAction(ActionEvent e) throws IOException {
		...
		if (radio_H.isSelected()) {
			...
			PersonneNec per = DAO_PersonneNec.getByCIN(Supprimer_PerNece_Controller.cin_p);
				...
				per.setGenre(genre);
				int status =  DAO_PersonneNec.Modifier(per);
				if (status > 0) {

					Alert alert = new Alert(AlertType.INFORMATION);
					alert.setTitle("Modification D'un personne necessiteux");
	...
	public static Boolean nom_valide=true;
	public static Boolean prenom_valide=true;
	public static Boolean adress_valide=true;
	public static Boolean revenue_valide=true;
	public static Boolean code_valide=true;
	public static Boolean profession_valide=true;
	public static Boolean nembreEnfant_valide=true;
	public static Boolean tel_valide=true;
	public static Boolean date_valide=true;

	public static boolean Valide() {
		if ((nom_valide == true) && (prenom_valide == true) && (adress_valide == true)	&& 
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		PersonneNec per = DAO_PersonneNec.getByCIN(Supprimer_PerNece_Controller.cin_p);
		txt_nom.setText(per.getNom());
		txt_prenom.setText(per.getPrenom());
		txt_adress.setText(per.getAdresse());
		txt_tel.setText(String.valueOf(per.getTel()));
		txt_nbEnf.setText(String.valueOf(per.getNombreEnf()));
		txt_codepostal.setText(String.valueOf(per.getCodePostale()));
		txt_pro.setText(String.valueOf(per.getProfession()));
		txt_rev.setText(String.valueOf(per.getRevenuAnnuelle()));
